...
class PRbinaryHop(MessagePassing):
    def __init__(self, k_loops,alpha,beta,dropout = 0.0,cached = False,
                add_self_loops = True,normalize = True, **kwargs):
        kwargs.setdefault('aggr', 'add')
        super(PRbinaryHop,self).__init__(**kwargs)
    ...
    def __repr__(self):
        return f'{self.__class__.__name__}(K={self.k_loops}, alpha={self.alpha},beta={self.beta})'
